...
export const ProductFilters=({selectedCategory,onCategoryChange,priceRange,onPriceChange}:Props)=>{
    return(
        ...
        bg-gray-900 p-4 rounded-lg shadow-lg">
            ...
            className="border border-gray-400 bg-gray text-gray-300 rounded-lg px-4 
            ...
            <div className="flex gap-3 items-center">
                <div className="flex flex-col">
                    <label className="text-xs text-gray-300 mb-1 text-center">Min price</label>
                <input
                type="number"
                value={priceRange[0]}
                onChange={(e)=>onPriceChange([Number(e.target.value),priceRange[1]])}
                className="border border-gray-400 rounded-lg px-3 py-2 w-24
                ...
                <div className="flex flex-col">
                    <label className="text-xs text-gray-300 mb-1 text-center">Max price</label>
                <input
                type="number"
                value={priceRange[1]}
